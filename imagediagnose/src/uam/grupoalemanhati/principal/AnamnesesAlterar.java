 ...
 * @version 1.0
 * 
 * JFrame AnamnesesAlterar - Permite Alterar as Anamneses e Inserir Imagens
 */

public final class AnamnesesAlterar extends javax.swing.JFrame {
     ...
     */
    public AnamnesesAlterar(Usuario usuario, int linhaSelecionada) throws SQLException, ParseException {
        initComponents();
        //Obtem o objeto Anamnese
        AnamnesesAlterar.linhaSelecionada = linhaSelecionada;
        AnamnesesAlterar.usuario = usuario;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTable1.getSelectedRow() >= 0) {
            try {
                ...
                Logger.getLogger(AnamnesesAlterar.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            new AnamneseDao().atualizar(anamnese);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //adiciona somente o de imagens
        fileChooser.addChoosableFileFilter(new FileNameExtensionFilter("Imagens", "jpg", "png", "tif"));
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                //Cria o objeto AnamneseImagem
                AnamneseImagem anamneseImagem = new AnamneseImagem();
                //Id da Anamnese
                anamneseImagem.setIdAnamnese(anamnese.getId());
                //Descricao é o nome do arquivo
                anamneseImagem.setDescricao(imagemArquivo.getName());
                //Arquivo em Bytes
                anamneseImagem.setImagem(arquivoBytes);
                
                //Insere no Banco
                new AnamneseImagemDao().inserir(anamneseImagem);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(jTable1.getSelectedRow() >= 0) {
            try {
                int idImagemSelecionada = (int) jTable1.getValueAt(jTable1.getSelectedRow(),0);
                new AnamneseImagemDao().apagar(idImagemSelecionada);
                atualizarTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnamnesesAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new AnamnesesAlterar(usuario, linhaSelecionada).setVisible(true);
                } catch (SQLException | ParseException ex) {
                    Logger.getLogger(AnamnesesAlterar.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
